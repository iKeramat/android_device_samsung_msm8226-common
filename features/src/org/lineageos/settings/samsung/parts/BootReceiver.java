...
import org.lineageos.settings.samsung.parts.kcal.Utils;
...
public class BootReceiver extends BroadcastReceiver implements Utils {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        FileUtils.setValue(DeviceSettings.TORCH_BRIGHTNESS_PATH,
                Settings.Secure.getInt(context.getContentResolver(),
        ...
        FileUtils.setValue(DeviceSettings.OTG_ENABLER_PATH, Settings.Secure.getInt(
                context.getContentResolver(), DeviceSettings.PREF_OTG_ENABLER, 0));
    }
}
